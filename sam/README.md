...
```bash
dog-eared-sam$ sam logs -n StockCheckerFunction --stack-name dog-eared-sam --tail
```
...
```bash
dog-eared-sam$ cd functions/stock-checker
...
```bash
aws cloudformation delete-stack --stack-name dog-eared-sam
```
